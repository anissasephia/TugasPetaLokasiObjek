...
<body>
  ...
  <nav class="navbar bg-dark navbar-expand-lg bg-zinc-900 opacity-80 fixed-top" data-bs-theme="dark">
    <div class="container-fluid px-5">
      ...
      <button class="navbar-toggler" id="navButton" onclick="handleClick()" bg-sky-500 type="button" title="navbarButton" aria-expanded="false">
      ...
      <div class="navbar-collapse collapse" id="navbar">
        ...
        <?php if (auth()->loggedIn()) : ?>
          <div class="dropdown">
            <button class="btn btn bg-sky-500 text-white hover:bg-sky-600 rounded-lg dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              <?= auth()->user()->username ?>
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item  hover:bg-sky-800" href="<?= base_url('home/input') ?>">Input Data</a></li>
              <li><a class="dropdown-item hover:bg-sky-800" href="<?= base_url('home/table') ?>">Table</a></li>
              <li><a class="dropdown-item hover:bg-sky-800" href="<?= base_url('home/peta') ?>">Peta</a></li>
              <li><a class="dropdown-item text-white bg-sky-600 hover:bg-sky-500 me-2 " href="<?= base_url('logout') ?>">Log Out</a>
            </ul>
          </div>
        <?php else : ?>
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item text-white bg-sky-600 hover:bg-sky-500 me-2 " href="<?= base_url('login') ?>">Login</a>
            </ul>
          </div>
        <?php endif; ?>
      </div>
  ...
  <div class="pt-32 pb-20 px-5 bg-zinc-700">
    <div class="w-full container flex justify-between space-y-3 flex-col lg:space-x-3 lg:space-y-0 lg:flex-row">
      ...
      <button type="button" id="searchButton" class="w-1/3 btn bg-sky-500 text-white hover:bg-sky-600 rounded-lg">Search<i class="bi bi-search mx-2"></i></i></button>
    </div>
  </div>
            ...
            <div class="card h-[400px] w-full">
              ...
              <div class="card-body flex flex-column justify-between">
                ...
                <div class="flex justify-end mt-3 space-x-2">
                  <a type="button" class="btn bg-sky-500 text-white hover:bg-sky-600 " href="<?= base_url('home/peta') ?>#15/<?= $d['latitude'] ?>/<?= $d['longitude'] ?>">View Maps</a>
                </div>
              </div>
